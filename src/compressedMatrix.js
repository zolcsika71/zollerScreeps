...
CompressedMatrix.serialize = costMatrix => {
...
CompressedMatrix.deserialize = data => {
...
CompressedMatrix.compareEfficiency = (count, costMatrix = new PathFinder.CostMatrix(), verbose = true) => {
    ...
    const p = global.Util.startProfiling();
    const total = global.Util.startProfiling();
