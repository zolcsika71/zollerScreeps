...
let Setup = function (typeName) {
    ...
    this.isValidSetup = function (room) {
        ...
        let minEnergyAvailable = this.SelfOrCall(this._minEnergyAvailable, room),
            absEnergy = room.remainingEnergyAvailable,
            energy = room.relativeRemainingEnergyAvailable;
    ...
    this.parts = function (room) {
        let fixedBody = this.SelfOrCall(this._fixedBody, room),
            multiBody = this.SelfOrCall(this._multiBody, room),
            minMulti = this.SelfOrCall(this._minMulti, room),
            maxMulti = this.SelfOrCall(this._maxMulti, room),
